...
import {  AppRegistry,TouchableHighlight, View,  ScrollView,Image, Linking, StyleSheet, TouchableOpacity } from 'react-native';
import {  Card, Text, PricingCard, Tile, Icon } from 'react-native-elements';
    ...
    <ScrollView>
      <View style={styles.container}>
       <Image
                 ...
                 source={{uri: image }}/>
      <View>
       <Text style={{ fontWeight:'bold',fontSize: 20,marginTop:15,marginLeft: 10 }}>{title}</Text>
      <TouchableOpacity style={styles.button} onPress={this.onOpen.bind(this)}>
      <Image
           style={styles.img}
           source={require("../image/分享.png")}/>
        </TouchableOpacity>
      </View>
      <View style={{ margin:10 ,backgroundColor:"#fff", width:'90%'}}>
        <Text style={{padding: 10 }}>{descriptions}</Text>
      </View>
